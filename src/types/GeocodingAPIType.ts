...
//
//   const geocodingAPI = Convert.toGeocodingAPI(json);
//
...
export class Convert {
  public static toGeocodingAPI(json: string): GeocodingAPIType[] {
    return cast(JSON.parse(json), a(r('GeocodingAPI')));
  }

  public static geocodingAPIToJson(value: GeocodingAPIType[]): string {
    return JSON.stringify(uncast(value, a(r('GeocodingAPI'))), null, 2);
  }
}
